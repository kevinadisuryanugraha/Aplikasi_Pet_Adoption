...
<body>
    <div class="container">
        ...
        <div class="right">
            <span class="welcome">Selamat Datang <?php echo $user_name; ?></span>
                    ...
                    <?php foreach ($kucing_list as $index => $kucing): ?>
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?php if ($kucing['created_by'] == $user_id): ?>
                                    <a href="edit_kucing.php?id=<?php echo $kucing['id_kucing']; ?>" class="edit">Edit</a>
                                    <a href="delete_kucing.php?id=<?php echo $kucing['id_kucing']; ?>" class="delete">Delete</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
